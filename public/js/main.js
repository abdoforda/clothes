...
(function ($) {
  ...
  var btnQuantity = function () {
    $("body").on("click", ".minus-btn", function (e) {
      ...
      mainProduct.find("[name='number']").val(value);
      var price = parseFloat(mainProduct.find("[name='price']").val());
      var number = parseFloat(mainProduct.find("[name='number']").val());
      mainProduct.find(".price_final_show").text(price * number + " EGP");
  ...
  var deleteFile = function (e) {
    ...
    $("body").on("click", ".tf-mini-cart-remove", function (e) {
  ...
  var variantPicker = function () {
    if ($(".variant-picker-item").length) {
      $("body").on("click", ".variant-picker-item label.color", function (e) {
        $(this)
          .closest(".variant-picker-item")
          .find(".variant-picker-label-value")
          .text($(this).data("value"));
          $(this)
          .closest(".main_product")
          .find("[name='color']").val($(this).data("value"));
      });
      $("body").on("click", ".variant-picker-item label.size", function (e) {
        $(this)
          .closest(".variant-picker-item")
          .find(".variant-picker-label-value")
          .text($(this).data("value"));
          $(this)
          .closest(".main_product")
          .find("[name='size']").val($(this).data("value"));
      });
    }
    if ($(".variant-picker-item").length) {
  ...
  var totalPriceVariant = function () {
    ...
    var basePrice = parseFloat($(".price-on-sale").data("base-price")) || parseFloat($(".price-on-sale").text().replace("EGP", ""));
    ...
    $(".color-btn, .size-btn").on("click", function () {
      ...
      quantityInput.val(1);
      $(".price-on-sale").text("EGP" + newPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
      var totalPrice = newPrice;
      $(".total-price").text("EGP" + totalPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
    });
    ...
    function updateTotalPrice() {
      var currentPrice = parseFloat($(".price-on-sale").text().replace("EGP", ""));
