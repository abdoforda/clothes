                                ...
                                <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                    <div class="swiper-wrapper stagger-wrap">
                                        ...
                                        <div class="swiper-slide stagger-item" >
                                            <div class="item">
                                                <img class="lazyload" data-src="{{ asset('images/icons/play_video.png') }}" src="{{ asset('images/icons/play_video.png') }}" alt="img-product">
                                            </div>
                                        </div>
                                        @endif
                                ...
                                <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                    <div class="swiper-wrapper" >
                                        ...
                                        <div class="swiper-slide">
                                            <iframe width="100%" height="600" src="https://www.youtube.com/embed/{{ $product->youtube_id }}?autoplay=1" title="{{  $product->name }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                                        </div>
                                        @endif
                                        @foreach (json_decode($product->images) as $image)
