<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" dir="rtl" xml:lang="{{ str_replace('_', '-', app()->getLocale()) }}" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
...
<body class="preload-wrapper rtl">
                    ...
                    <div class="row wrapper-header align-items-center">
                        <div class="col-xl-5 tf-md-hidden">
                            <ul class="header-list-categories">
                                @php
                                    $categories = DB::table('cats')->where('show_navbar', 1)->get();
                                    $active_cat_id = 0;
                                    if(Route::currentRouteName() == 'shop.category' && Route::current()->parameter('slug') != null){
                                        $active_cat_id = DB::table('cats')->where('slug', Route::current()->parameter('slug'))->first()->id;
                                    }
                                @endphp
                                @foreach ($categories as $item)
                                <li class="categories-item {{ $active_cat_id == $item->id ? 'active' : '' }} "><a href="{{ route('shop.category', $item->slug) }}" class="text-uppercase">{{ $item->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="col-md-4 col-3 tf-lg-hidden">
                            <a href="home-multi-brand.html#mobileMenu" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                        ...
                        <div class="col-xl-5 col-md-4 col-3">
                            <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                                <li class="nav-search"><a href="home-multi-brand.html#canvasSearch" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="nav-icon-item"><i class="icon icon-search"></i></a></li>
                                <li class="nav-account"><a href="home-multi-brand.html#login" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-account"></i></a></li>
                                ...
                                <li class="nav-cart"><a href="home-multi-brand.html#shoppingCart" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-bag"></i><span class="count-box">0</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper-header d-flex justify-content-center align-items-center">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                <li class="menu-item">
                                    <a href="home-multi-brand.html#" class="item-link">Home<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            ...
                                            <div class="text-center view-all-demo">
                                                <a href="home-multi-brand.html#modalDemo" data-bs-toggle="modal" class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View all demos (34+)</span><i class="icon icon-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="menu-item">
                                    <a href="home-multi-brand.html#" class="item-link">Shop<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-2">
                                ...
                                <li class="menu-item">
                                    <a href="home-multi-brand.html#" class="item-link">Products<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <a href="home-multi-brand.html#" class="product-img">
                                                                            ...
                                                                            <div class="list-product-btn absolute-2">
                                                                                <a href="home-multi-brand.html#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                ...
                                                                                <a href="home-multi-brand.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                                                                                    <span class="icon icon-compare"></span>
                                                                                    <span class="tooltip">Add to Compare</span>
                                                                                    <span class="icon icon-check"></span>
                                                                                </a>
                                                                                <a href="home-multi-brand.html#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-multi-brand.html#" class="title link">Ribbed Tank Top</a>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            ...
                                                                            <div class="list-product-btn absolute-2">
                                                                                <a href="home-multi-brand.html#shoppingCart" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                    <span class="icon icon-bag"></span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-multi-brand.html#" class="title link">Oversized Printed T-shirt</a>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-multi-brand.html#" class="title">Oversized Printed T-shirt</a>
                                                                            <span class="price">$16.95</span>
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">White</span>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-multi-brand.html#" class="title link">V-neck linen T-shirt</a>
                                ...
                                <li class="menu-item position-relative">
                                    <a href="home-multi-brand.html#" class="item-link">Pages<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu submenu-default">
                                        <ul class="menu-list">
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">Brands</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                                        <li>
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">Contact</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">FAQ</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">Store</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">Payment</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                            ...
                                            <li class="menu-item-2">
                                                <a href="home-multi-brand.html#" class="menu-link-text link text_black-2">My account</a>
                                                <div class="sub-menu submenu-default">
                                                    <ul class="menu-list">
                                ...
                                <li class="menu-item position-relative">
                                    <a href="home-multi-brand.html#" class="item-link">Blog<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu submenu-default">
                                        <ul class="menu-list">
                        ...
                        <ul class="header-list-categories tf-lg-hidden">
                            <li class="categories-item active"><a href="home-multi-brand.html" class="text-uppercase">Women</a></li>
                            ...
                            <li class="categories-item"><a href="store-locations.html" class="text-uppercase">Find a Store</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p>Email: <a href="home-multi-brand.html#">info@fashionshop.com</a></p>
                                        </li>
                                        <li>
                                            <p>Phone: <a href="home-multi-brand.html#">(212) 555-1234</a></p>
                                        </li>
                                    </ul>
                                    <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                                    <ul class="tf-social-icon d-flex gap-10">
                                        <li><a href="home-multi-brand.html#" class="box-icon w_34 round social-facebook social-line"><i class="icon fs-14 icon-fb"></i></a></li>
                                        <li><a href="home-multi-brand.html#" class="box-icon w_34 round social-twiter social-line"><i class="icon fs-12 icon-Icon-x"></i></a></li>
                                        <li><a href="home-multi-brand.html#" class="box-icon w_34 round social-instagram social-line"><i class="icon fs-14 icon-instagram"></i></a></li>
                                        <li><a href="home-multi-brand.html#" class="box-icon w_34 round social-tiktok social-line"><i class="icon fs-14 icon-tiktok"></i></a></li>
                                        <li><a href="home-multi-brand.html#" class="box-icon w_34 round social-pinterest social-line"><i class="icon fs-14 icon-pinterest-1"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-newsletter footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        ...
                                        <form class="form-newsletter" id="subscribe-form" action="home-multi-brand.html#" method="post" accept-charset="utf-8" data-mailchimp="true">
    ...
    <div class="tf-toolbar-bottom type-1150">
        <div class="toolbar-item">
            <a href="home-multi-brand.html#toolbarShopmb" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
        ...
        <div class="toolbar-item">
            <a href="home-multi-brand.html#canvasSearch" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                <div class="toolbar-icon">
        ...
        <div class="toolbar-item">
            <a href="home-multi-brand.html#login" data-bs-toggle="modal">
                <div class="toolbar-icon">
        ...
        <div class="toolbar-item">
            <a href="home-multi-brand.html#shoppingCart" data-bs-toggle="modal">
                <div class="toolbar-icon">
                    <i class="icon-bag"></i>
            ...
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#dropdown-menu-one" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-one">
                            <span>Home</span>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#dropdown-menu-two" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-two">
                            <span>Shop</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-two" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li><a href="home-multi-brand.html#sub-shop-one" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-one">
                                ...
                                <li>
                                    <a href="home-multi-brand.html#sub-shop-two" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-two">
                                        <span>Features</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                ...
                                <li>
                                    <a href="home-multi-brand.html#sub-shop-three" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-three">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#dropdown-menu-three" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-three">
                            <span>Products</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-three" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li>
                                    <a href="home-multi-brand.html#sub-product-one" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-one">
                                ...
                                <li>
                                    <a href="home-multi-brand.html#sub-product-two" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-two">
                                ...
                                <li>
                                    <a href="home-multi-brand.html#sub-product-three" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-three">
                                ...
                                <li>
                                    <a href="home-multi-brand.html#sub-product-four" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-four">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#dropdown-menu-four" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-four">
                            <span>Pages</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-four" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                ...
                                <li><a href="home-multi-brand.html#sub-account" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-account">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#dropdown-menu-five" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-five">
                            <span>Blog</span>
                            <span class="btn-open-sub"></span>
                        </a>
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                        ...
                        <div id="cate-menu-one" class="collapse list-cate">
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="home-multi-brand.html#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                        <div class="image">
                                ...
                                <li>
                                    <a href="home-multi-brand.html#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                        <div class="image">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#cate-menu-two" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-two">
                            <div class="image">
                                <img src="images/shop/cate/cate6.jpg" alt="">
                            </div>
                            <span>Men</span>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-multi-brand.html#cate-menu-three" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-three">
                            <div class="image">
                                <img src="images/shop/cate/cate9.jpg" alt="">
                            </div>
                            <span>Women</span>
            ...
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="" action="my-account.html" accept-charset="utf-8">
                        ...
                        <div>
                            <a href="home-multi-brand.html#forgotPassword" data-bs-toggle="modal" class="btn-link link">Forgot your password?</a>
                        </div>
                        <div class="bottom"> 
                            <div class="w-100">
                            ...
                            <div class="w-100">
                                <a href="home-multi-brand.html#register" data-bs-toggle="modal" class="btn-link fw-6 w-100 link">
            ...
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="">
                        ...
                        <div>
                            <a href="home-multi-brand.html#login" data-bs-toggle="modal" class="btn-link link">Cancel</a>
                        </div>
                        <div class="bottom"> 
                            <div class="w-100">
                ...
                <div class="tf-login-form">
                    <form class="">
                        ...
                        <div class="bottom"> 
                            ...
                            <div class="w-100">
                                <a href="home-multi-brand.html#login" data-bs-toggle="modal" class="btn-link fw-6 w-100 link">
                    ...
                    <div class="tf-mini-cart-wrap">
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-cart-tax">Taxes and <a href="home-multi-brand.html#">shipping</a> calculated at checkout</div>
                                ...
                                <div class="tf-cart-checkbox">
                                    ...
                                    <label for="CartDrawer-Form_agree">
                                        I agree with the 
                                        <a href="home-multi-brand.html#" title="Terms of Service">terms and conditions</a>
                                    </label>
                                </div>
                        ...
                        <div class="tf-mini-cart-tool-openable estimate-shipping">
                            ...
                            <div class="tf-mini-cart-tool-content">
                                ...
                                <div class="tf-cart-tool-btns">
                                    <a href="home-multi-brand.html#" class="tf-btn fw-6 justify-content-center btn-fill w-100 animate-hover-btn radius-3"><span>Estimate</span></a>
                ...
                <div class="wrap">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form class="">
                            ...
                            <a href="home-multi-brand.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-product-btn-wishlist box-icon bg_white compare btn-icon-action">
                                <span class="icon icon-compare"></span>
                                <span class="icon icon-check"></span>
                            </a>
                            <div class="w-100">
                                <a href="home-multi-brand.html#" class="btns-full">Buy with <img src="images/payments/paypal.png" alt=""></a>
                                <a href="home-multi-brand.html#" class="payment-more-option">More payment options</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <a href="home-multi-brand.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-product-btn-wishlist hover-tooltip box-icon bg_white compare btn-icon-action">
                                        <span class="icon icon-compare"></span>
                                        <span class="tooltip">Add to Compare</span>
                                        <span class="icon icon-check"></span>
                                    </a>
